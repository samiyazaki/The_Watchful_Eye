...
async function addEmployee() {
    let answer = await inquirer.prompt([
        ...
        },
        {
            type: "input",
            name: "role_id",
            message: "What is the role of this employee? 1 for Branch, 2 for Operations and 3 for Outside sales.",
        },
        {
            type: "input",
            name: "manager_id",
            message: "Which manager do they report to? 1 for Branch, 2 for Operations.",
        },
    ]);
    await db.query(
